...
-- ─────────────────────────────────────────────────────────────────────────────
-- v_session_online_actions
-- Per session: every auditable online action (sanitize / block_call /
-- terminate_session) joined with the corresponding finding detail.
-- Used by session detail page to display the "Online Actions" section,
-- showing what was done to harmful content in real time.
-- ─────────────────────────────────────────────────────────────────────────────
